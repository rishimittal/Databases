...
public class DBSystem {
    ...
    private static String PATH_FOR_DATA;
...
*/
    ...
    public String getRecord(String tableName, int recordld){
    ...
    private void initializePage(Page page, int endR, int curr) {
        page.setEndRecord(endR);
        page.setCurrentSize(curr);
    }

    private void initializePage(Page page, int pageID, int startR, int fileO, String tab) {
    ...
    */
    public Page addContentsToPage(Page p, String tableName){
    ...
    public void updateRecordBuffer(String tableName, int recordld){
        HashMap<Page,Integer> hm=pageInfo.get(tableName);
        Iterator it = hm.entrySet().iterator();
        Page p;
        while (it.hasNext()) {
