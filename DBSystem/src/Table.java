...
public class Table {
    ...
    private HashMap<String , Integer> unique_attr_counts;
    ...
    public HashMap<String, Integer> getUnique_attr_counts() {
        return unique_attr_counts;
    }

    public void setUnique_attr_counts(HashMap<String, Integer> unique_attr_counts) {
        this.unique_attr_counts = unique_attr_counts;
    }
}
